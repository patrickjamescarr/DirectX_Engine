...
namespace DX
{
    ...
    public:
        ...
        UINT                    GetBackBufferWidth() const { return std::max<UINT>(m_outputSize.right - m_outputSize.left, 1); }
        UINT                    GetBackBufferHeight() const { return std::max<UINT>(m_outputSize.bottom - m_outputSize.top, 1); }
        ...
        // projection matrix
        void SetProjection(DirectX::SimpleMath::Matrix value) { m_projection = value; }
        DirectX::SimpleMath::Matrix GetProjection() { return m_projection; }

        // view matrix
        void SetView(DirectX::SimpleMath::Matrix value) { m_view = value; }
