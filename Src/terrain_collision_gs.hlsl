...
///
/// Terrain collision geometry shader 
///
/// Samples the denisty function in 26 different directions which
/// is read via stream output for use in accurate collision detection
///
